...
const About = () => (
    <Layout>
        ...
        <p>I began self-schooling on web development concepts and in 2007 I started working with Spiegel Design Group (SDG) as the sole backend developer. Over the years we grew the company, working with clients such as The Drybar, IT Cosmetics, ReserveBar, simplehuman, Korn Ferry, and many others. As the team grew, my role became more managerial as I ran the day-to-day operations of the company, but I continued to contribute as a developer as needed.</p>
